...
A machine learning model that outputs a single probability doesn't solve this. A retention
...
6. **A report** — everything above, delivered as a single Excel file a
   retention or operations team can open directly. No server, no login, no app
   to learn.
